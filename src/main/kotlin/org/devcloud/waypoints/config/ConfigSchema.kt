    ...
    companion object {
        fun load(cfg: YamlConfiguration): ConfigSchema =
            ConfigSchema(
                ...
                teleportCooldown = Duration.ofSeconds(cfg.getInt("teleport.cooldown-seconds", 10).toLong()),
                teleportWarmup = Duration.ofSeconds(cfg.getInt("teleport.warmup-seconds", 0).toLong()),
